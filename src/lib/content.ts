...
export const REFERRAL = {
  ...
  text: "За каждого приглашённого друга, который оформит eSIM, вы получаете 5 ГБ трафика бесплатно на баланс. Приглашать можно бесконечное количество пользователей.",
} as const;
...
export const ESIM_SETUP_PRICE = 14; // USD, единоразово + оплата по тарифу
