...
export async function middleware(request: NextRequest) {
  ...
  // Защита: если ключи Supabase не заданы — не роняем сайт,
  // просто пропускаем запрос без проверки сессии.
  ...
  try {
    ...
    // если Supabase недоступен — не роняем сайт, пускаем как гостя
    return response;
  }
